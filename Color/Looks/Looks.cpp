 ...
 *
 * Looks is free software: you can redistribute it and/or modify
 * it under the terms of the GNU General Public License version 2 as published
 * by the Free Software Foundation.
 *
 * Looks is distributed in the hope that it will be useful,
...
#define kPluginName "Looks"
#define kPluginGrouping "Color"
#define kPluginIdentifier "net.fxarena.openfx.Looks"
...
{
public:
    LooksPlugin(OfxImageEffectHandle handle)
...
void
LooksPlugin::changedParam(const OFX::InstanceChangedArgs &args, const std::string &paramName)
{
...
mDeclarePluginFactory(LooksPluginFactory, {}, {});

void
LooksPluginFactory::describe(ImageEffectDescriptor &desc)
{
...
void
LooksPluginFactory::describeInContext(ImageEffectDescriptor &desc, ContextEnum context)
{
    ...
    PageParamDescriptor *page = LooksPlugin::describeInContextBegin(desc, context);
    {
    ...
    LooksPlugin::describeInContextEnd(desc, context, page);
}

OFX::ImageEffect*
LooksPluginFactory::createInstance(OfxImageEffectHandle handle, ContextEnum /*context*/)
{
    return new LooksPlugin(handle);
}

static LooksPluginFactory p(kPluginIdentifier, kPluginVersionMajor, kPluginVersionMinor);
